...
## Scenario
High-volume low-margin trap (Eval)

Large low-margin orders can soak up capacity unless the agent follows commercial weighting correctly. This held-out eval variant uses a different hidden random seed and a shifted shortage profile.
