...
## Scenario
Promo protection on RET_A (Eval)

RET_A runs a major summer feature in weeks 13-14 while capacity is tight in both weeks. This held-out eval variant uses a different hidden random seed and a shifted shortage profile.
