...
## Scenario
High-margin premium scarcity (Eval)

Premium SKUs are margin-critical and selected RET_D rows are launching into a sparse week 16. This held-out eval variant uses a different hidden random seed and a shifted shortage profile.
