...
## Scenario
Strategic account protection (Eval)

RET_B is a strategic customer and needs to be protected during a broad capacity squeeze. This held-out eval variant uses a different hidden random seed and a shifted shortage profile.
