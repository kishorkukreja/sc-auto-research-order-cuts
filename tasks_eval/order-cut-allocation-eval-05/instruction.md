...
## Scenario
Balanced shortage across all weeks (Eval)

Capacity stays below demand for the whole horizon with no single catastrophic week. This held-out eval variant uses a different hidden random seed and a shifted shortage profile.
